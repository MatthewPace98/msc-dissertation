...
\mainmatter 
    %\input{intro/introduction_main} 
    \input{lit_review/background_and_lit_overview_main}
    \input{method/materials_and_methods_main}
    %\input{results/results_and_discussion_main}
    %\input{conclusion/conclusions_main}
    %\appendix
...
\end{document}
% This needs to be 32k words in length
